...
1. Open an issue describing the user-visible problem.
2. Keep the extension zero-permission and fully local.
3. Do not add remote services, analytics, accounts, ads, or remotely hosted code.
